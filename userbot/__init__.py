...
import os
import sys
from userbot.Config import Vars
...
if bool(ENV):
    ...
    # Last.fm Module
    BIO_PREFIX = os.environ.get("BIO_PREFIX", "Meow userbot is op @Murat_30_God")
    DEFAULT_BIO = os.environ.get("DEFAULT_BIO", "Meow userbot is op @Murat_30_God")
